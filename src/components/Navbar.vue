          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-2">
              <a
                ...
                >{{this.langVN ?"Về bản thân": "About"}}</a
              >
            </li>
            <li class="nav-item mx-2">
              <a
            ...
            <li class="nav-item ml-2">
              ...
              >
                🌐
                <span :class="{ 'font-weight-bold text-success': langVN }"
                  >VI</span
                >
                |
                <span :class="{ 'font-weight-bold text-success': !langVN }"
...
export default {
  ...
  methods: {
    ...
    switchLanguage() {
      this.localLang = !this.localLang;
      this.$emit("langVN", this.localLang);
    },
  },
};
</script>
