              ...
              >
                <div>
                  <div class="title2" style="font-weight: 500">
                    {{ langVN ? design.title.vi : design.title.en }}
                  </div>
                  <span
                  ...
                  >
                  •
                  <span class="date ml-1">{{ langVN ? design.date.vi : design.date.en }}</span>
                </div>

                <button
                  style="height: 50px; margin-top: 5px; white-space: nowrap"
                  class="btn-sm btn btn-outline-secondary no-outline"
                  @click.prevent="showModalFn(design)"
                >
                  {{ langVN ? "Xem thêm" : "Read more" }}
                </button>
              </div>
            </div>
          </div>
